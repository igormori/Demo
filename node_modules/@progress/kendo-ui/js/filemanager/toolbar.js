	    ...
	    var FileManagerToolBar = ToolBar.extend({
	        ...
	        defaultTools: {
	            ...
	            changeView: { type: "buttonGroup", text: "Change View", name:"changeView",
	                buttons: [
	                    { name: "listView", icon: "grid-layout", togglable: true, group: "changeView", command: "ChangeViewCommand", options: "list" },
	                    { name: "gridView", icon: "grid", togglable: true, group: "changeView", command: "ChangeViewCommand", options: "grid" }
	                ]
	            },
	            spacer: { type: "spacer" },
