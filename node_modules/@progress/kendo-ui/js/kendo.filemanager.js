...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __meta__ = { // jshint ignore:line
	    ...
	    depends: [ "core", "data", "listview", "toolbar", "breadcrumb", "menu", "treeview", "upload", "dialog", "switch", "resizable" ],
	    features: [{
	...
	(function($, undefined) {
	    ...
	    var FileManager = DataBoundWidget.extend({
	        init: function(element, options) {
	            ...
	            that._hasUpload = (that.options.uploadUrl || (that.options.upload.async && that.options.upload.async.saveUrl)) &&
	                                 that.options.upload !== false;
